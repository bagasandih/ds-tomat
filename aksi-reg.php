		...
		<div class="card">
			...
			<?php
				if(isset($_POST['submit'])) {
					...
					$query = "INSERT INTO pasien (nama_pasien, no_hp, alamat, tgl_konsul, id_penyakit, gejala, total_perhitungan) VALUES ('".$name."', '".$no_hp."', '".$alamat."', '".$tglkonsul."', '".$row[0]."', '".serialize($pilihan_user)."', '".$densitas_baru[$codes[0]]."')";
					...
					if($koneksi->query($query) === TRUE):
						...
						echo '<h5><i class="icon fas fa-info"></i> Hasil Diagnosa Awal!</h5>';
						echo "Terdeteksi penyakit <b>{$row[2]}</br> dengan derajat kepercayaan ".round($densitas_baru[$codes[0]],2)." % <br>";
						echo "<a href='proses_cetak.php?id=".$last_id."' class='btn btn-primary btn-flat '><i class='fa fa-print'></i> Cetak Laporan</a>";
						echo "<a href='index.php' class='btn btn-danger'><i class='fa fa-sign-out-alt'></i> Kembali</a>";
						echo '</div>';
					else:
